...
export const dancer: EffectType = {
  ...
  name: "Idol",
  category: "wacky",
  description: "One seed-grown low-poly creature with a face like an animal that does not exist. Move can keep them dancing in place or send them drifting, floating, or orbiting. Mini army fills the frame with tiny ones in sync",
  params: [
