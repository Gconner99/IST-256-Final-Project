    ...
    <div class="help" id="help">
      <div class="card">
        ...
        <ul>
          ...
          <li><strong>Idol</strong> plants a small low-poly 3D creature in the frame — stamp it to grow a new one, turn Count up to 4 for a little crowd, set Place to Scatter + depth to drop them around the picture (some closer, some farther). Keep the top-bar box on so Rand all includes it.</li>
...
function paintRail(n: HTMLElement) {
  ...
  n.innerHTML = `
    ...
    <div class="status" style="margin-top:4px">Floaters drift across. An idol is a small low-poly dancer with a made-up animal face — stamp to grow a new one, Count plants more, Place can scatter them with depth.</div>
