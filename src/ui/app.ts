    ...
    <div class="help" id="help">
      <div class="card">
        ...
        <ul>
          ...
          <li><strong>Idol</strong> plants a small low-poly 3D creature — stamp it to grow a weirder one, Echo leaves a color-shifted trail, Count spaces a crowd, Place can scatter them with depth. Keep the top-bar box on so Rand all includes it.</li>
