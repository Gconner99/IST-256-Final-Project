    ...
    <div class="help" id="help">
      <div class="card">
        ...
        <ul>
          ...
          <li><strong>Idol</strong> plants a small low-poly 3D creature — stamp it, turn Count up for a spaced crowd, Echo leaves a color-shifted afterimage, Place can scatter them with depth. Keep the top-bar box on so Rand all includes it.</li>
...
function paintRail(n: HTMLElement) {
  ...
  n.innerHTML = `
    ...
    <div class="status" style="margin-top:4px">Floaters drift across. An idol is a small low-poly dancer with a made-up animal face — stamp to grow a new one, Count spaces a crowd, Echo trails a ghost.</div>
