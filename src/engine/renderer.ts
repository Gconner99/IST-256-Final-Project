...
export class Renderer {
  ...
  private drawHeraldry(target: FBO | null, src: MediaSource, time: number, seed: number, duration: number, width: number, height: number) {
    ...
    const canvas = this.heraldry.paint({
      ...
      springElast: look.collageSpringElast,
      springBreak: look.collageSpringBreak,
      flowScale: look.collageFlowScale,
      flowTurb: look.collageFlowTurb,
      flowEvolve: look.collageFlowEvolve,
      flowForce: look.collageFlowForce,
      flowDepth: look.collageFlowDepth,
      boidCohere: look.collageBoidCohere,
      boidSep: look.collageBoidSep,
      boidAlign: look.collageBoidAlign,
      boidRadius: look.collageBoidRadius,
      boidSpeed: look.collageBoidSpeed,
      poleCount: look.collagePoleCount,
      poleAttract: look.collagePoleAttract,
      poleRepel: look.collagePoleRepel,
