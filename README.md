...
- Procedural backgrounds: plasma, noise, bars, plus **Stars**, **Marsh**, **Oil**, **Paper**, **Cave**, **Stage** (toy-pop piano / notes / instruments), **Sketch** (sticker-notebook paper), **Felt**, **Foil**, and **Plush**
